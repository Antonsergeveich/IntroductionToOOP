...
{
	double x; //поле класса или члены класса
	double y;
public: // Модификатор доступа: public - открытые поля (доступ где угодно), private - закрытые поля (доступ только внутри класса)
